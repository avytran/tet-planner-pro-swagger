# 📘 Tet Planner Pro – Swagger Setup Guide
...
## 3. Install OpenAPI (Swagger) Editor Extension
...
In the search bar, type: **OpenAPI (Swagger) Editor**

### Step 3: Install Extension

1. Select the extension named OpenAPI (Swagger) Editor.
2. Click Install.
3. Wait until installation is complete.

---

## 4. Open and Preview Swagger File
